/*
 * Copyright 2015 Jason Pritchard
...
/* Currently unused when setting frequency in dai driver.
 * see snd_soc_dai_set_sysclk
 */
#define TLV320AIC3x_CLK	12000000
...
static int imx_tlv320aic3x_dai_init(struct snd_soc_pcm_runtime *rtd)
{
	...
	ret = snd_soc_dai_set_sysclk(rtd->codec_dai, 0, TLV320AIC3x_CLK, SND_SOC_CLOCK_IN);
...
static const struct snd_soc_dapm_widget imx_tlv320aic3x_dapm_widgets[] = {
	...
	SND_SOC_DAPM_MIC("Mic Bias 2V", NULL),
...
static int imx_tlv320aic3x_probe(struct platform_device *pdev)
{
	...
	data->codec_clk = clk_get(&codec_dev->dev, "clock-frequency");
...
static const struct of_device_id imx_tlv320aic3x_of_ids[] = {
	{ .compatible = "fsl,imx-audio-tlv320aic3x", },
	{ }
};
MODULE_DEVICE_TABLE(of, imx_tlv320aic3x_of_ids);
...
static struct platform_driver imx_tlv320aic3x_driver = {
	.driver = {
		...
		.owner = THIS_MODULE,
		.of_match_table = imx_tlv320aic3x_of_ids,
	},
...
MODULE_AUTHOR("Jason Pritchard <pritchard.jason[at]gmail[dot]com>");
